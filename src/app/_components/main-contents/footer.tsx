...
export default function Footer() {
  ...
  return (
    <>
      <div className="flex h-fit w-full flex-col items-center py-6 bg-slate-200 dark:bg-black">
        ...
        <div className="flex flex-row gap-6 my-2">
          ...
          {/* X */}
          <a href={`${process.env.NEXT_TWITTER}`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-8 h-8">
          ...
          {/* LinkedIn */}
          <a href={`${process.env.NEXT_LINKEDIN}`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-8 h-8">
          ...
          {/* Instagram */}
          <a href={`${process.env.NEXT_INSTAGRAM}`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-8 h-8">
